...
#define IO_API_H_
...
#ifdef WIN32
  #ifdef io_EXPORTS // defined by CMake when building the library
  ...
  // Also do not warn when a DLL-exported class is derived from a
  // non-DLL-exported class. This happens with boost::noncopyable.
