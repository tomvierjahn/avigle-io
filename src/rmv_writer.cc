...
////////////////////////////////////////////////////////////////////////////////
RmvWriter::RmvWriter
(const std::string& fileName, RmvVersion rmvVersion)
: fOutputPath(fileName)
, fVersion(rmvVersion)
{
  ...
  if (!bf::exists(this->fOutputPath.parent_path()))
  {
	  bf::create_directories(this->fOutputPath.parent_path());
  }
}
